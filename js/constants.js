...
C.JS_KEYCODE_SHARP_S = 219;
C.JS_KEYCODE_OE = 192;
C.JS_KEYCODE_UE = 186;
C.JS_KEYCODE_AE = 222;
C.JS_KEYCODE_PLUS = 187;
C.JS_KEYCODE_HASH = 191;
C.JS_KEYCODE_DASH = 189;
C.JS_KEYCODE_ANGLE_BRACKET_L = 226;
C.JS_KEYCODE_SPACE = 32;
C.JS_KEYCODE_COMMA = 188;
C.JS_KEYCODE_PERIOD = 190;
...
C.KEYCODE_MAPPING[91] = 'KEY_GUI'; //Windows
C.KEYCODE_MAPPING[92] = 'KEY_RIGHT_GUI';

C.SPECIAL_LETTER_KEYCODES = [C.JS_KEYCODE_SHARP_S, C.JS_KEYCODE_PLUS, C.JS_KEYCODE_HASH, C.JS_KEYCODE_DASH, C.JS_KEYCODE_PERIOD, C.JS_KEYCODE_COMMA, C.JS_KEYCODE_ANGLE_BRACKET_L, C.JS_KEYCODE_SPACE, C.JS_KEYCODE_OE, C.JS_KEYCODE_UE, C.JS_KEYCODE_AE];
C.PRINTABLE_KEYCODES = C.PRINTABLE_KEYCODES.concat(C.SPECIAL_LETTER_KEYCODES);
...
C.SUPPORTED_KEYCODES = C.SUPPORTED_KEYCODES.concat(C.SPECIAL_LETTER_KEYCODES);

C.SPECIAL_KEYCODES = [];
C.SUPPORTED_KEYCODES.forEach(function (code) {
    if (!C.PRINTABLE_KEYCODES.includes(code)) {
        C.SPECIAL_KEYCODES.push(code);
    }
});
...
C.BTN_MODES = [C.BTN_MODE_BUTTON_1, C.BTN_MODE_BUTTON_2, C.BTN_MODE_BUTTON_3,
    ...
    C.BTN_MODE_SIP, C.BTN_MODE_PUFF];

C.TRANSLATIONS = {};
C.TRANSLATIONS[C.BTN_MODE_BUTTON_1] = ['Button 1'];
C.TRANSLATIONS[C.BTN_MODE_BUTTON_2] = ['Button 2'];
C.TRANSLATIONS[C.BTN_MODE_BUTTON_3] = ['Button 3'];
C.TRANSLATIONS[C.BTN_MODE_STICK_UP] = ['Stick up', 'Stick nach oben'];
C.TRANSLATIONS[C.BTN_MODE_STICK_DOWN] = ['Stick down', 'Stick nach unten'];
C.TRANSLATIONS[C.BTN_MODE_STICK_LEFT] = ['Stick left', 'Stick nach links'];
C.TRANSLATIONS[C.BTN_MODE_STICK_RIGHT] = ['Stick right', 'Stick nach rechts'];
C.TRANSLATIONS[C.BTN_MODE_SIP] = ['Sip function', 'Funktion ansaugen'];
C.TRANSLATIONS[C.BTN_MODE_PUFF] = ['Puff function', 'Funktion blasen'];